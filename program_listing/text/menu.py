...
def enter_airport_details():
    ...
    while not valid_response:
        ...
        if not valid_response:
            print(
                'Sorry, that is not a valid code, or the airport you are looking for does not exist.')
    else:
...
def calculate_cost():
    if global_data.uk_airport == '' or global_data.overseas_airport is None:
        ...
        airplane_max = global_data.airplane_types_data[global_data.airplane_type][
            global_data.max_range]
