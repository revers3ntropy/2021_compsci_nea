...
def first_seats_checker(message):
	try:
		...
		if number == 0:
			...
			if number < global_data.airplane_types_data[global_data.airplane_type][global_data.max_capasity] / 2:
				return True
	except:
		pass
	return False
...
first_seats_box = buttons.TextBoxWithCheck(mid_x, mid_y + 50, typing.retro_8x10, '000', 3, first_seats_checker)
...
def run():
	...
	typing.write(typing.retro_8x10, 'Number of first class seats:', (renderer.mid_x, renderer.mid_y))
	if save_button.run():
	...
	typing.write(typing.retro_8x10, 'Airplane type: ' + message, (renderer.mid_x, renderer.mid_y - 200))
